        ...
        <div class="content-container">
            ...
            <div class="center-block">
                <div class="buttons-container">
                    <a href="javascript:history.back();" style="float: none;">返回</a>
                </div>
            </div>
            <!-- <div class="buttons-container">
            ...
            <div class="" style="text-align: center;">
                <a href="<?php echo url('/');?>" style="margin: 0 10px;" id="t-a-home">返回主页</a>
                <a href="<?php echo url('/');?>" style="margin: 0 10px;">反馈错误</a>
            </div>
        </div>
        <script type="text/javascript">
            if (document.referrer && (lIndex = document.referrer.indexOf('web/')) != -1) {
                var homeUrl = document.referrer.substring(0, lIndex + 'web/'.length);
                document.getElementById('t-a-home').href = homeUrl;
            }
        </script>
    </body>
</html>