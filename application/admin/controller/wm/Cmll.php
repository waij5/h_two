...
class Cmll extends Backend
{
    ...
    public function index(){
        ...
        {	
			...
			$tDefaultWhere = ['m.mprimary_type'=> '5', 'm.mbelong_type'=> '4'];		//主类型5：领料；所属类型4：耗材
			$lDefaultWhere = ['mf.mprimary_type'=> '5', 'mf.mbelong_type'=> '4'];
    ...
    public function add(){
    	if($this->model->select()){
			...
			$this->view->assign("man_num", 'hclq1');
        }
        ...
        if($this->request->isPost()){
        	...
        	if($params){
        		...
        		if($searchMan_num){
					...
					$stocklogData['slexplain'] = '领取单'.$params['man_num'];
