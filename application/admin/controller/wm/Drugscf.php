        ...
        if($this->request->isAjax()){
            ...
            if($lot_id){
                $msg = db('wm_lotnum')->alias('l')
                        ->field('l.lot_id,l.lotnum,l.lcost,l.lprice,l.lstock,l.lstime,l.letime,p.pro_name,p.pro_spec,u.name as uname,d.name as dname')
        ...
        if ($this->request->isGet())
        {
            ...
            if($ids){
                $data = db('wm_recipe')->alias('r')
                        ->field('r.re_id,sl.sldr_id, sl.slcustomer_id, sl.slnum, sl.slotid, p.pro_name, p.pro_spec, lot.lotnum,lot.lstime, lot.letime,lot.lstock, sl.slcost,sl.slprice, u.name as uname,d.name as dname')
