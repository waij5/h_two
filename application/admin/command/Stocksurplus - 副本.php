...
class Stocksurplus extends Command
{
    ...
    protected function execute(Input $input, Output $output)
    {
        ...
        if (!isset($params['where']) || !isset($params['extraWhere'])) {
            ...
            $otherSlData='';
            if($nowDate > $etime){
                $otherWhere['sl.sltime'] = ['between',[strtotime($etime.'23:59:59'),strtotime($nowDate.'23:59:59')]];
...
//更新20190111
                    ...
                    $mergeDatas[$k]['otherjhallcost'] = isset($mergeOtherDatas[$k]['jhallcost'])?$mergeOtherDatas[$k]['jhallcost']:0;
                    $mergeDatas[$k]['otherjhallprice'] = isset($mergeOtherDatas[$k]['jhallprice'])?$mergeOtherDatas[$k]['jhallprice']:0;

                    $mergeDatas[$k]['otherqtrk'] = isset($mergeOtherDatas[$k]['qtrk'])?$mergeOtherDatas[$k]['qtrk']:0;
                    $mergeDatas[$k]['otherqtrkallcost'] = isset($mergeOtherDatas[$k]['qtrkallcost'])?$mergeOtherDatas[$k]['qtrkallcost']:0;
                    $mergeDatas[$k]['otherqtrkallprice'] =isset($mergeOtherDatas[$k]['qtrkallprice'])?$mergeOtherDatas[$k]['qtrkallprice']:0;

                    $mergeDatas[$k]['otherdbrk'] = isset($mergeOtherDatas[$k]['dbrk'])?$mergeOtherDatas[$k]['dbrk']:0;
                    $mergeDatas[$k]['otherdbrkallcost'] = isset($mergeOtherDatas[$k]['dbrkallcost'])?$mergeOtherDatas[$k]['dbrkallcost']:0;
                    $mergeDatas[$k]['otherdbrkallprice'] =isset($mergeOtherDatas[$k]['dbrkallprice'])?$mergeOtherDatas[$k]['dbrkallprice']:0;

                    $mergeDatas[$k]['otherpyrk'] = isset($mergeOtherDatas[$k]['pyrk'])?$mergeOtherDatas[$k]['pyrk']:0;
                    $mergeDatas[$k]['otherpyrkallcost'] = isset($mergeOtherDatas[$k]['pyrkallcost'])?$mergeOtherDatas[$k]['pyrkallcost']:0;
                    $mergeDatas[$k]['otherpyrkallprice'] =isset($mergeOtherDatas[$k]['pyrkallprice'])?$mergeOtherDatas[$k]['pyrkallprice']:0;

                    $mergeDatas[$k]['otherthrk'] = isset($mergeOtherDatas[$k]['thrk'])?$mergeOtherDatas[$k]['thrk']:0;
                    $mergeDatas[$k]['otherthrkallcost'] = isset($mergeOtherDatas[$k]['thrkallcost'])?$mergeOtherDatas[$k]['thrkallcost']:0;
                    $mergeDatas[$k]['otherthrkallprice'] =isset($mergeOtherDatas[$k]['thrkallprice'])?$mergeOtherDatas[$k]['thrkallprice']:0;

                    $mergeDatas[$k]['otherrkcj'] = isset($mergeOtherDatas[$k]['rkcj'])?$mergeOtherDatas[$k]['rkcj']:0;
                    $mergeDatas[$k]['otherrkcjallcost'] = isset($mergeOtherDatas[$k]['rkcjallcost'])?$mergeOtherDatas[$k]['rkcjallcost']:0;
                    $mergeDatas[$k]['otherrkcjallprice'] =isset($mergeOtherDatas[$k]['rkcjallprice'])?$mergeOtherDatas[$k]['rkcjallprice']:0;

                    $mergeDatas[$k]['otherpkcj'] = isset($mergeOtherDatas[$k]['pkcj'])?$mergeOtherDatas[$k]['pkcj']:0;
                    $mergeDatas[$k]['otherpkcjallcost'] = isset($mergeOtherDatas[$k]['pkcjallcost'])?$mergeOtherDatas[$k]['pkcjallcost']:0;
                    $mergeDatas[$k]['otherpkcjallprice'] =isset($mergeOtherDatas[$k]['pkcjallprice'])?$mergeOtherDatas[$k]['pkcjallprice']:0;

                    $mergeDatas[$k]['othergqcj'] = isset($mergeOtherDatas[$k]['gqcj'])?$mergeOtherDatas[$k]['gqcj']:0;
                    $mergeDatas[$k]['othergqcjallcost'] = isset($mergeOtherDatas[$k]['gqcjallcost'])?$mergeOtherDatas[$k]['gqcjallcost']:0;
                    $mergeDatas[$k]['othergqcjallprice'] =isset($mergeOtherDatas[$k]['gqcjallprice'])?$mergeOtherDatas[$k]['gqcjallprice']:0;

                    $mergeDatas[$k]['otherqtcj'] = isset($mergeOtherDatas[$k]['qtcj'])?$mergeOtherDatas[$k]['qtcj']:0;
                    $mergeDatas[$k]['otherqtcjallcost'] = isset($mergeOtherDatas[$k]['qtcjallcost'])?$mergeOtherDatas[$k]['qtcjallcost']:0;
                    $mergeDatas[$k]['otherqtcjallprice'] =isset($mergeOtherDatas[$k]['qtcjallprice'])?$mergeOtherDatas[$k]['qtcjallprice']:0;

                    $mergeDatas[$k]['otherly'] = isset($mergeOtherDatas[$k]['ly'])?$mergeOtherDatas[$k]['ly']:0;
                    $mergeDatas[$k]['otherlyallcost'] =  isset($mergeOtherDatas[$k]['lyallcost'])?$mergeOtherDatas[$k]['lyallcost']:0;
                    $mergeDatas[$k]['otherlyallprice'] = isset($mergeOtherDatas[$k]['lyallprice'])?$mergeOtherDatas[$k]['lyallprice']:0;

                    $mergeDatas[$k]['otherll'] = isset($mergeOtherDatas[$k]['ll'])?$mergeOtherDatas[$k]['ll']:0;
                    $mergeDatas[$k]['otherllallcost'] = isset($mergeOtherDatas[$k]['llallcost'])?$mergeOtherDatas[$k]['llallcost']:0;
                    $mergeDatas[$k]['otherllallprice'] =isset($mergeOtherDatas[$k]['llallprice'])?$mergeOtherDatas[$k]['llallprice']:0;

                    $mergeDatas[$k]['otherfy'] = isset($mergeOtherDatas[$k]['fy'])?$mergeOtherDatas[$k]['fy']:0;
                    $mergeDatas[$k]['otherfyallcost'] = isset($mergeOtherDatas[$k]['fyallcost'])?$mergeOtherDatas[$k]['fyallcost']:0;
                    $mergeDatas[$k]['otherfyallprice'] =isset($mergeOtherDatas[$k]['fyallprice'])?$mergeOtherDatas[$k]['fyallprice']:0;

                    $mergeDatas[$k]['othercy'] = isset($mergeOtherDatas[$k]['cy'])?$mergeOtherDatas[$k]['cy']:0;
                    $mergeDatas[$k]['othercyallcost'] = isset($mergeOtherDatas[$k]['cyallcost'])?$mergeOtherDatas[$k]['cyallcost']:0;
                    $mergeDatas[$k]['othercyallprice'] =isset($mergeOtherDatas[$k]['cyallprice'])?$mergeOtherDatas[$k]['cyallprice']:0;
//更新20190111            
                }
                ...
                foreach($mergeDatas as $k => $v){
                    ...
                    $mergeDatas[$k]['beginCost'] = bcadd(bcadd(bcadd(bcadd(bcadd(bcadd(bcadd(bcadd(bcadd(bcadd(bcadd(bcadd(bcadd(bcadd(bcadd(bcadd(bcadd(bcadd(bcadd(bcadd(bcadd(bcadd(bcadd(bcadd(bcadd(bcadd($v['allSurplusCost'], -$v['jhallcost'],2), -$v['otherjhallcost'],2), -$v['qtrkallcost'],2), -$v['otherqtrkallcost'],2), -$v['dbrkallcost'],2), -$v['otherdbrkallcost'],2), -$v['pyrkallcost'],2), -$v['otherpyrkallcost'],2), -$v['thrkallcost'],2), -$v['otherthrkallcost'],2), $v['rkcjallcost'],2), $v['otherrkcjallcost'],2), $v['pkcjallcost'],2), $v['otherpkcjallcost'],2), $v['gqcjallcost'],2), $v['othergqcjallcost'],2), $v['qtcjallcost'],2), $v['otherqtcjallcost'],2), $v['lyallcost'],2), $v['otherlyallcost'],2), $v['llallcost'],2), $v['otherllallcost'],2), $v['fyallcost'],2), $v['otherfyallcost'],2), -$v['cyallcost'],2), -$v['othercyallcost'],2);
                    ...
                    $mergeDatas[$k]['nowEnterCost'] = bcadd(bcadd(bcadd(bcadd(bcadd(bcadd(bcadd(bcadd($v['jhallcost'], $v['qtrkallcost'],2), $v['dbrkallcost'],2),  $v['pyrkallcost'],2),  $v['thrkallcost'],2),  -$v['rkcjallcost'],2),  -$v['pkcjallcost'],2),  -$v['gqcjallcost'],2),  -$v['qtcjallcost'],2);
                    $mergeDatas[$k]['nowOutCost'] = bcadd(bcadd(bcadd($v['lyallcost'],$v['llallcost'],2),  $v['fyallcost'],2),  -$v['cyallcost'],2);
                    ...
                    $mergeDatas[$k]['endStock'] = intval($v['pro_stock']-$v['otherjh']-$v['otherqtrk']-$v['otherdbrk']-$v['otherpyrk']-$v['otherthrk']+$v['otherrkcj']+$v['otherpkcj']+$v['othergqcj']+$v['otherqtcj']+$v['otherly']+$v['otherll']+$v['fy']-$v['cy']);

                    $mergeDatas[$k]['endCost'] = bcadd(bcadd(bcadd(bcadd(bcadd(bcadd(bcadd(bcadd(bcadd(bcadd(bcadd(bcadd(bcadd($v['allSurplusCost'], -$v['otherjhallcost'],2), -$v['otherqtrkallcost'],2), -$v['otherdbrkallcost'],2),  -$v['otherpyrkallcost'],2),  -$v['otherthrkallcost'],2), $v['otherrkcjallcost'],2), $v['otherpkcjallcost'],2), $v['othergqcjallcost'],2), $v['otherqtcjallcost'],2), $v['otherlyallcost'],2), $v['otherllallcost'],2), $v['otherfyallcost'],2), -$v['othercyallcost'],2);
                ...
                foreach($mergeDatas as $k => $v){
                    ...
                    $mergeDatas[$k]['beginCost'] = bcadd(bcadd(bcadd(bcadd(bcadd(bcadd(bcadd(bcadd(bcadd(bcadd(bcadd(bcadd(bcadd($v['allSurplusCost'], -$v['jhallcost'],2), -$v['qtrkallcost'],2), -$v['dbrkallcost'],2),  -$v['pyrkallcost'],2),  -$v['thrkallcost'],2),  $v['rkcjallcost'],2),  $v['pkcjallcost'],2),  $v['gqcjallcost'],2),  $v['qtcjallcost'],2),  $v['lyallcost'],2),  $v['llallcost'],2),  $v['fyallcost'],2),  -$v['cyallcost'],2);
