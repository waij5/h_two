...
<script type="text/javascript">
    ...
    <ul id="myTab" class="nav nav-tabs">
        <li class="active">
            <a href="#basic" data-toggle="tab">科室领料单明细</a>
        </li>
    </ul>
		        ...
		        <div class="col-xs-12 col-sm-12" style="width: 100%;overflow-x: scroll;"><!--startprint-->
		            ...
		            <table id="selectedDrugs" class="table table-striped table-bordered table-hover" style="width: 1320px;text-align: center;">
		                ...
		                <tr>
		                    ...
		                    <td class="wpmcWidth" style="width: 80px;">物品名称</td>
		                    <td class="phWidth" style="width: 60px;">批号</td>
		                    <td class="printB" style="width: 40px;">剩余库存</td>
		                    <td class="llslWidth" style="width: 40px;">领料数量</td>
		                ...
		                <tr>
		                    ...
		                    <?php if($vo['backtype'] =='' && date('Y-m',$row['mcreatetime']) == date('Y-m')): ?><button class="btn btn-xs btn-danger backGoods"  data-ml_id="<?php echo $vo['ml_id']; ?>" data-mpro_num="<?php echo $vo['mpro_num']; ?>" >退&nbsp;&nbsp;&nbsp;料</button ><?php elseif($vo['backtype'] =='1'): ?><a href="javascript:;" class="btn btn-xs btn-primary "  >已退料</a><?php elseif($vo['backtype'] =='2'): ?><a href="javascript:;" class="btn btn-xs btn-info "  >退料记录</a><?php endif; ?></td>
		                ...
		                <tr class="printA" style="display: none;text-align: left">
		                    ...
		                    <td colspan="2">领料日期：<?php echo date("Y-m-d",$row['mcreatetime']); ?></td>
		                </tr>
		                <tr class="printA" style="display: none;text-align: left">
		                ...
		                <tr  class="printA borderNone"  style="display: none;text-align: left;">
		                	<th colspan="3" style="border:none">领料人:</th>
