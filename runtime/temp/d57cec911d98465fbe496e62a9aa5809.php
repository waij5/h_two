...
<div>
                ...
                <div class="col-xs-6 col-sm-7" style="">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12" id="pro_menu"  onmouseleave="$('#words').addClass('hidden');">
                            <input type="text" readonly <?php if($data): ?>value="药品名：<?php echo $data[0]['pro_name']; ?>    << >>    应发药数量：<?php echo $data[0]['deduct_times']; ?>"<?php else: ?>value=''<?php endif; ?> style="position: relative;" class="form-control keyword" onmouseenter="$('#words').removeClass('hidden')"/>
                            <div style="position: relative;width: 130%">
                                <table id="words" data-index="" style="list-style:none;position: absolute;cursor: pointer;z-index: 999;height: auto;max-height: 200px;overflow-y: auto;padding: 0;table-layout:fixed;background-color: white" class=" resultList table table-striped table-bordered table-hover alldata">
                                    <tr class="onloading"><th width="12%">药品编号</th><th width="27%">名称</th><th width="12%">批号</th><th width="10%">进价</th><th width="10%">可用库存</th><th width="7%">单位</th><th width="10%">规格</th><th width="13%">到期日期</th></tr>
    ...
    <div class="form-group" style="width: 100%;overflow-x: scroll;">
        ...
        <table id="selectedDrugs" class="table table-striped table-bordered table-hover alldata" style="width: 900px;text-align: center;">
            <tr>
            <td style="color: red;width: 120px;">药品名称</td>
            <td style="color: red;width: 60px;">批号</td>
            <td style="width: 50px;">库存</td>
            <td style="color: red;width: 50px;">发药数量</td>
            <td style="color: red;width: 50px;">仓库</td>
    ...
    <div class="form-group layer-footer">
        ...
        <div class="col-xs-12 col-sm-8">
            <?php if($type==1): ?><button type="submit" class="btn btn-success btn-embossed disabled" id="sure">确定发药</button><?php else: ?><button type="button" class="btn btn-success btn-embossed disabled" id="sureFy">确定发药</button><?php endif; ?>
