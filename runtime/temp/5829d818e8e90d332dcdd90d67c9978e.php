            ...
            <div class="tab-pane fade active in" id="one">
                <div class="widget-body no-padding">
                        ...
                        <form class="form-inline form-commonsearch nice-validator n-default" action="" novalidate="novalidate" id="f-commonsearch" role="form" method="post">
                            <fieldset>
                                ...
                                <div class="form-group dislocationAll">
                                    <label for="proname" class="control-label labelLocation"><?php echo __('Sup_name'); ?></label>
                                    <input type="text" name="sup_name" class="form-control" >
                                </div>

                                <div class="form-group dislocationAll">
                                    <label for="contact" class="control-label labelLocation"><?php echo __('Sup_contact'); ?></label>
                                    <input type="text" name="sup_contact" class="form-control" >
                                </div>
                                <div class="form-group dislocationAll">
                                    <label for="tel" class="control-label labelLocation"><?php echo __('Sup_tel'); ?></label>
                                    <input type="text" name="sup_tel" class="form-control" >
                                </div>
                                <div class="form-group dislocationAll">
                                    <label for="tel" class="control-label labelLocation"><?php echo __('Sup_type'); ?></label>
                                    <select  id="c-type" data-rule="" class="form-control selectpicker" name="sup_type">
                    ...
                    <table id="table" class="table table-striped table-bordered table-hover" 
                           data-operate-edit="<?php echo $auth->check('wm/supplier/edit'); ?>" 
                           data-operate-del="<?php echo $auth->check('wm/supplier/del'); ?>" 
                           width="100%">
                    </table>
                </div>
            </div>
