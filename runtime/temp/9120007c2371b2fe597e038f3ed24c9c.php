...
<form id="add-form" class="form-horizontal" role="form" data-toggle="validator" method="POST" action=""  autocomplete="off"  onkeydown="if(event.keyCode==13){return false;}">
    ...
    <div class="form-group col-sm-6">
        ...
        <div class="col-xs-12 col-sm-5">
            <input id="c-pro_code"  value="<?php echo $yp_num; ?>" class="form-control" name="row[pro_code]" type="text">
        </div>
    ...
    <div class="form-group col-sm-6">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-approv_num" data-rule="" class="form-control" name="row[approv_num]" type="text" >
        </div>
    </div>
    ...
    <div class="form-group col-sm-6">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-regist_num" data-rule="" class="form-control" name="row[regist_num]" type="text">
        </div>
    </div>
    ...
    <div class="form-group col-sm-6">
        ...
        <div class="col-xs-12 col-sm-5">
            ...
            <?php echo build_select('row[pro_fee_type]', $proFeeType, null, ['class'=>'form-control selectpicker', 'data-rule'=>'']); ?>
        </div>
    </div>
    ...
    <div class="form-group col-sm-6">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select  id="c-ptype" class="form-control selectpicker" name="row[ptype]">
