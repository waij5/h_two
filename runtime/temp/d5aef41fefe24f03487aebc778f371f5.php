...
<form id="view-form" class="form-horizontal" role="form" data-toggle="validator" method="POST" action="">
    <ul id="myTab" class="nav nav-tabs">
        <li class="active">
            <a href="#basic" data-toggle="tab">药品进货单明细</a>
        </li>
    </ul>
            ...
            <div class="panel-body">
				...
				<div class="form-group ">
			        ...
			        <style>
			            ...
			            <table id="selectedDrugs" class="table table-striped table-bordered table-hover" style="width: 1250px;text-align: center;">

			                <!-- //4.10  打印 -->
			                <tr class="printA" style="display: none;text-align: center;">
			                    <td colspan="10">
			                    <?php echo !empty($site['hospital'])?$site['hospital']:''; ?><br/>
			                    药品进货单
			                    </td>
			                </tr>
			                <!-- //4.10  打印 -->
			                ...
			                <tr>
			                    ...
			                    <td class="jhWidth" style="width: 40px;">进货数量</td>
			                ...
			                <!-- //4.10  打印 -->
			                <tr class="printB" style="text-align: left">

			                    <td colspan="5" style="text-align: right;"><b style="color: red">合计：</b></td>
			                    <td colspan="1" style="text-align: center;"><b style="color: red"><?php echo $totalCost; ?></b></td>
			                    <td colspan="8"></td>
			                </tr>
			                ...
			                <tr class="printA" style="display: none;text-align: left">
			                    ...
			                    <td colspan="2">进货日期：<?php echo date("Y-m-d",$row['mcreatetime']); ?></td>
			                </tr>
			                <tr class="printA" style="display: none;text-align: left">
