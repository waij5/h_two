            ...
            <div class="tab-pane fade active in" id="one">
                <div class="widget-body no-padding" >
                        ...
                        <form class="form-inline form-commonsearch nice-validator n-default" action="" novalidate="novalidate" id="f-commonsearch" role="form" method="post">
                            <fieldset>
                               ...
                               <div class="form-group dislocationAll">
                                    <label for="a_id" class="control-label labelLocation">ID</label>
                                    <input type="text" name="a_id" class="form-control" size="8" />
                                </div>
                                <div class="form-group dislocationAll">
                                    <label for="a_code" class="control-label labelLocation">编号</label>
                                    <input type="text" name="a_code" class="form-control" size="8">
                                </div>
                                <div class="form-group dislocationAll">
                                    <label for="a_name" class="control-label labelLocation">名称</label>
                                    <input type="text" name="a_name" class="form-control" size="8">
                                </div>
                                <div class="form-group dislocationAll">
                                    <label for="a_depot" class="control-label labelLocation">仓库</label>
                                    <select id="a_depot"  class="form-control " name="a_depot">
                                        <option></option>
                    ...
                    <table id="table" class="table table-striped table-bordered table-hover" 
                           data-operate-edit="<?php echo $auth->check('wm/apparatus/edit'); ?>" 
                           data-operate-del="<?php echo $auth->check('wm/apparatus/del'); ?>" 
                           >
                    </table>
                </div>
