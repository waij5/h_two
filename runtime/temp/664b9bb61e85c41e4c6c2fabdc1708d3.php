            ...
            <div class="tab-pane fade active in" id="one">
                <div class="widget-body no-padding">
                    ...
                    <div class="commonsearch-table hidden">
                        <form class="form-inline form-commonsearch nice-validator n-default" action="" novalidate="novalidate" id="f-commonsearch" role="form" method="post">
                            <fieldset>
                                ...
                                <div class="form-group dislocationAll">
                                    <label for="num" class="control-label labelLocation">编号</label>
                                    <input type="text" name="pro_code" class="form-control" size="8" />
                                </div>
                                <div class="form-group dislocationAll">
                                    <label for="name" class="control-label labelLocation">耗材名称</label>
                                    <input type="text" name="pro_name" class="form-control" size="8">
                                </div>
                                <div class="form-group" style="margin:5px">
                                    <label for="code" class="control-label" style="padding:0 10px">拼音码</label>
                                    <input type="text" name="pro_spell" class="form-control"  size="8">
                                </div>
                                <div class="form-group dislocationAll">
                                    <label for="depot_id" class="control-label labelLocation">所属仓库</label>
                                ...
                                <div class="form-group dislocationAll">
                                    <label for="c-pro_cat1" class="control-label labelLocation">所属科目</label>
                                ...
                                <div class="form-group dislocationAll">
                                    <label for="c-pro_cat2" class="control-label labelLocation">所属类别</label>
                    ...
                    <table id="table" class="table table-striped table-bordered table-hover" 
                           data-operate-edit="<?php echo $auth->check('wm/cm/edit'); ?>" 
                           data-operate-del="<?php echo $auth->check('wm/cm/del'); ?>" 
                           width="100%">
                    </table>
                </div>
            </div>
