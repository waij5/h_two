...
<script type="text/javascript">
    ...
    <ul id="myTab" class="nav nav-tabs">
        <li class="active">
            <a href="#basic" data-toggle="tab">科室领药单明细</a>
        </li>
    </ul>
...
<input type="hidden" name="man_id" value="<?php echo $row['man_id']; ?>" id="c-man_id" >
		    ...
		    <div class="form-group col-sm-6">
		        ...
		        <div class="col-xs-12 col-sm-8">
		            <select id="c-mdepart_id" disabled="" class=" form-control" name="row[mdepart_id]" data-live-search="true">
		                <option value=""></option>
		    ...
		    <div class="form-group col-sm-6">
		        ...
		        <div class="col-xs-12 col-sm-8">
		            <select id="c-mout_id" disabled class=" form-control" name="row[mout_id]" data-live-search="true">
		    ...
		    <div class="form-group col-sm-6">
		        ...
		        <div class="col-xs-12 col-sm-8">
		            <input type="text" name="row[member_id]" readonly="" class="form-control" id="field_ctm_id" value="<?php echo $row['ctm_name']; ?>">
		        </div>
		    ...
		    <div class="form-group ">
		        ...
		        <div class="col-xs-12 col-sm-8">
		        	<?php if(date('Y-m-d',$row['mcreatetime']) == date('Y-m-1')): ?>
		            	<a href="javascript:;" class="btn btn-primary" id="alterLyDate" ><i class="fa fa-reply"></i> 反日期</a>
		            <?php endif; ?>
            ...
            <div class="form-group">
		        <div class="col-xs-12 col-sm-12" style="width: 100%;overflow-x: scroll;">

		        <?php if(strstr($site['hospital'],'广州')): ?><input type="hidden" name="hospital_name" class="hospital_name" value="1"> <?php else: ?> <!--startprint--><?php endif; ?>
		        	<style>
		            ...
		            <table id="selectedDrugs" class="table table-striped table-bordered table-hover" style="width: 1320px;text-align: center;">
		                ...
		                <tr>
		                    ...
		                    <td class="lyslWidth" style="width: 40px;">领药数量</td>
		                ...
		                <tr>
		                    ...
		                    <?php if($vo['backtype'] =='' && date('Y-m',$row['mcreatetime']) == date('Y-m')): ?><button class="btn btn-xs btn-danger backDrugs"  data-ml_id="<?php echo $vo['ml_id']; ?>" data-mpro_num="<?php echo $vo['mpro_num']; ?>" >退&nbsp;&nbsp;&nbsp;药</button ><?php elseif($vo['backtype'] =='1'): ?><a href="javascript:;" class="btn btn-xs btn-primary "  >已退药</a><?php elseif($vo['backtype'] =='2'): ?><a href="javascript:;" class="btn btn-xs btn-info "  >退药记录</a><?php endif; ?></td>
		            ...
		            <?php if(strstr($site['hospital'],'广州')): else: ?> <!--endprint--><?php endif; ?>


		            <!-- 广州领药打印 -->
		            <?php if(strstr($site['hospital'],'广州')): ?><!--startprint--> <?php else: endif; ?>

		        	<style>
						body{background-color: #fff;}
						#ribbon{display: none;}
						#selectedDrugss td{border:2px solid !important;}
						.borderNone tr{border:1px solid white !important;}
						.borderNone th{border:1px solid white !important;}
					</style>

		            <table id="selectedDrugss" class="table table-striped table-bordered table-hover printA" style="width: 1320px;display: none;text-align: center;">

		                
		                <tr class="printA" style="display: none;text-align: center;">
		                    <td colspan="7"><?php echo $site['hospital']; ?><br/>
			                    科室领药单
		                    </td>
		                </tr>
		                ...
		                <tr class="printA" style="display: none;text-align: left">
		                    <td colspan="2" class="mdepartName"></td>
		                    <td colspan="5" >备注：<?php echo $row['mremark']; ?></td>
		                </tr>
		                <tr  class="printA borderNone"  style="display: none;text-align: left;">
		                	<th colspan="2" style="border:none">领药人:</th>
		                	<th colspan="3" style="border:none">经手人:</th>
		                	<th colspan="2" style="border:none">审核人:</th>
		                </tr>
		                

		            </table>
		            <?php if(strstr($site['hospital'],'广州')): ?><!--endprint--> <?php else: endif; ?>
