                ...
                <div class="widget-body no-padding">
                    ...
                    <table id="table" class=" table table-striped table-bordered table-hover" style="width: 100%;" >
                        <tr style="">
                            ...
                            <th>生产日期</th>
                            <th>有效日期</th>
                            <!-- <?php if($auth->isSuperAdmin()): ?><th style="text-align: center">操作</th><?php endif; ?> -->
