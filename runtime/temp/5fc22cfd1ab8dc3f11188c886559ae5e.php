            ...
            <div class="tab-pane fade active in" id="one">
                <div class="widget-body no-padding">
                        ...
                        <form class="form-inline form-commonsearch nice-validator n-default" action="" novalidate="novalidate" id="f-commonsearch" role="form" method="post">
                            <fieldset>
                               ...
                               <div class="form-group dislocationAll">
                                ...
                                <div class="form-group dislocationAll">
                                    <label for="mout_id" class="control-label labelLocation"><?php echo __('mout_id'); ?></label>
                                    <select id="mout_id"  class="selectpicker show-tick form-control " name="mout_id" data-live-search="true">
                                ...
                                <div class="form-group dislocationAll">
                                    <label for="mdepart_id" class="control-label labelLocation"><?php echo __('mdepart_id'); ?></label>
                                    <select id="mdepart_id" data-rule="required" class="selectpicker show-tick form-control " name="mdepart_id"data-live-search="true">
                                        <option value="">---请选择---</option>
                                ...
                                <div class="form-group dislocationAll">
                                    <label for="member_name" class="control-label labelLocation"><?php echo __('member_id'); ?></label>
                                    <input type="text" name="member_name" class="form-control" size="8">
                                </div>
                                ...
                                <div class="form-group dislocationAll">
                                    <label for="time" class="control-label labelLocation"><?php echo __('mcreatetime'); ?></label>
                    ...
                    <table id="table" class="table table-striped table-bordered table-hover" 
                           data-operate-edit="<?php echo $auth->check('wm/goodsll/edit'); ?>" 
                           data-operate-del="<?php echo $auth->check('wm/goodsll/del'); ?>" 
                           width="100%">
                    </table>
                </div>
            </div>
