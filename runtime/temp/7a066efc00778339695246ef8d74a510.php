...
<br>
    <div class="form-group col-sm-6">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="a_code" data-rule="required" value="<?php echo $row['a_code']; ?>" class="form-control" name="row[a_code]" type="text">
        </div>
    ...
    <div class="form-group col-sm-6">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="a_name" data-rule="required" class="form-control" name="row[a_name]" value="<?php echo $row['a_name']; ?>" type="text">
        </div>
    </div>
<br>
    <div class="form-group col-sm-6">
        ...
        <div class="col-xs-12 col-sm-8">
            <select id="a_unit" data-rule="required" class="form-control selectpicker" name="row[a_unit]" >
                ...
                <option value="<?php echo $vo['id']; ?>" <?php if(in_array(($vo['id']), is_array($row['a_unit'])?$row['a_unit']:explode(',',$row['a_unit']))): ?>selected<?php endif; ?>><?php echo $vo['name']; ?></option>
    ...
    <div class="form-group col-sm-6">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="a_spec" data-rule="required" class="form-control" name="row[a_spec]" type="text" value="<?php echo $row['a_spec']; ?>">
        </div>
    </div>
    ...
    <div class="form-group col-sm-6">
        ...
        <div class="col-xs-12 col-sm-8">
            <select id="a_depot" data-rule="required" class="form-control " name="row[a_depot]">
                ...
                <option value="<?php echo $vo['id']; ?>" <?php if(in_array(($vo['id']), is_array($row['a_depot'])?$row['a_depot']:explode(',',$row['a_depot']))): ?>selected<?php endif; ?>><?php echo $vo['name']; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </div>
    </div>
    ...
    <div class="form-group col-sm-12">
        ...
        <div class="col-xs-12 col-sm-9">
            <input id="a_remark" class="form-control" name="row[a_remark]" type="text" value="<?php echo $row['a_remark']; ?>">
        </div>
    </div>
