            ...
            <div class="tab-pane fade active in" id="one">
                <div class="widget-body no-padding">
                        ...
                        <form class="form-inline form-commonsearch nice-validator n-default" action="" novalidate="novalidate" id="f-commonsearch" role="form" method="post">
                            <fieldset>
                               ...
                               <div class="form-group dislocationAll">
                                ...
                                <div class="form-group dislocationAll">
                                    <label for="mstatus" class="control-label labelLocation">状态</label>
                                    <select id="mstatus"  class="form-control  show-tick" name="mstatus" data-live-search="true">
                                    <option value=""></option>
                                    <option value="1">待核收</option>
                                    <option value="2">已核收</option>
                                ...
                                <div class="form-group dislocationAll">
                                    <label for="time" class="control-label labelLocation">采购时间</label>
                    ...
                    <table id="table" class="table table-striped table-bordered table-hover" 
                           data-operate-edit="<?php echo $auth->check('wm/purchase/edit'); ?>" 
                           data-operate-del="<?php echo $auth->check('wm/purchase/del'); ?>" 
                           width="100%">
                    </table>
                </div>
            </div>
