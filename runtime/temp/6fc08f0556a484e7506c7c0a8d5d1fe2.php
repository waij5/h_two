            ...
            <div class="tab-pane fade active in" id="one">
                <div class="widget-body no-padding">
                    ...
                    <div class="commonsearch-table">
                        <form class="form-inline  nice-validator nice-validator n-default" action="<?php echo url('wmreport/checks/index'); ?>" id="f-commonsearch" role="form" method="post">
...
<!--startprint-->
                       ...
                       <div style="text-align: center;font-weight:bold;font-size: 20px;">仓库盘点表</div>
					</div>
