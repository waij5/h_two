<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:67:"D:\wamp\www\h_two\public/../application/admin\view\index\index.html";i:1544673822;s:67:"D:\wamp\www\h_two\public/../application/admin\view\common\meta.html";i:1544673823;s:69:"D:\wamp\www\h_two\public/../application/admin\view\common\header.html";i:1551316857;s:67:"D:\wamp\www\h_two\public/../application/admin\view\common\menu.html";i:1565158000;s:70:"D:\wamp\www\h_two\public/../application/admin\view\common\control.html";i:1544673823;s:69:"D:\wamp\www\h_two\public/../application/admin\view\common\script.html";i:1544673823;}*/ ?>
<!DOCTYPE html>
    ...
    <body class="hold-transition skin-green sidebar-mini fixed" id="tabs">
        <div class="wrapper">
            ...
            <header id="header" class="main-header">
                <style>.webLogo{width: 30px;margin-top: 10px;float: left;}</style>
<!-- Logo -->
<a href="javascript:;" class="logo">
	<img class="webLogo img-circle" src="__CDN__/assets/img/webLogo.png" />
    <!-- 迷你模式下Logo的大小为50X50 -->
    <span class="logo-mini"><?php echo strtoupper(mb_substr($site['name'],0,4,'utf-8')); ?></span>
    <!-- 普通模式下Logo -->
    <!-- <span class="logo-lg"><b></b></span> -->
    <span class="logo-lg"><?php echo htmlspecialchars($site['name']); ?></span>
</a>
<!-- 顶部通栏样式 -->
<nav class="navbar navbar-static-top">
    <!-- 边栏切换按钮-->
    <a href="#" class="sidebar-toggle shiftDeSim" onclick="" role="button" title="点击切换菜单">
    ...
    <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown notifications-menu">
                ...
                <a href="javascript:;" title="消息" id="h-message">
            ...
            <!-- 当天预约到诊 -->
            <!-- <li>
                <a href="javascript:;"  title="当天预约到诊" id="h-bookcustomer">
...
<section class="sidebar">
	<!-- Sidebar user panel -->
	<div class="user-panel hidden-xs sideUserInfo">
		<div class="pull-left">
			<!--<a href="general/profile" class="addtabsit">-->
				<!--<img src="__CDN__<?php echo $admin['avatar']; ?>" class="img-circle" />-->
				<label class="sideLoginName"><?php echo $admin['nickname']; ?></label>
			<!--</a>-->
		</div>
	...
	<ul class="sidebar-menu menuSimple<?php if((!cookie('use_simple_menu'))): ?> hidden<?php endif; ?>">
		<li>
			<?php if(($auth->check('customer/customerreception'))): ?>
			<a href="/customer/customerreception" addtabs="247" url="/customer/customerreception" py="fzjd" pinyin="fenzhenjiedai">
				<img class="menuIcon" src="__CDN__/assets/img/menuIco/customerreception.ico" />
				分配接待
			</a>
		...
		<li>
			<?php if(($auth->check('customer/customerosconsult/index'))): ?>
			<a href="/customer/customerosconsult/index" addtabs="240" url="/customer/customerosconsult" py="xczxgl" pinyin="xianchangzixunguanli">
				<img class="menuIcon" src="__CDN__/assets/img/menuIco/customerosconsult.ico" />
				现场客服
			</a>
			<?php endif; ?>
		</li>
		<li>
			<?php if(($auth->check('customer/customerconsult/index'))): ?>
			<a href="/customer/customerconsult/index" addtabs="231" url="/customer/customerconsult" py="zxgl" pinyin="zixunguanli">
				<img class="menuIcon" src="__CDN__/assets/img/menuIco/customerconsult.ico" />
				网电客服
			</a>
			<?php endif; ?>
		</li>
		<li>
			<?php if(($auth->check('cash/balance'))): ?>
			<a href="/cash/balance" addtabs="184" url="/cash/balance" py="sygl" pinyin="shouyinguanli">
				<img class="menuIcon" src="__CDN__/assets/img/menuIco/cash.ico" />
				收银管理
			</a>
			<?php endif; ?>
		</li>
		<!--<li>
			<?php if(($auth->check('cash/order/deptconsumption'))): ?>
			<a href="/cash/order/deptconsumption" addtabs="529" url="/cash/order/deptconsumption" py="ksxf" pinyin="keshixiaofei">
				<img src="__CDN__/assets/img/menuIco/dept.ico" />
				科室消费
			</a>
			<?php endif; ?>
		</li>-->
		<li>
			<?php if(($auth->check('cash/order/operation'))): ?>
			<a  href="/cash/order/operation" addtabs="211" url="/cash/order/operation" py="sshl" pinyin="shoushuhuli">
				<img class="menuIcon" src="__CDN__/assets/img/menuIco/operation.ico" />
				手术护理
			</a>
			<?php endif; ?>
		</li>
		<li>
			<?php if(($auth->check('base/operaterota/index'))): ?>
			<a  href="/base/operaterota/index" addtabs="784" url="/base/operaterota/index" py="sspb" pinyin="shoushupaiban">
				<img class="menuIcon" src="__CDN__/assets/img/menuIco/sspb.png" />
				手术值班
			</a>
			<?php endif; ?>
		</li>
		...
		<li>
			<?php if(($auth->check('customer/customer/index'))): ?>
			<a href="/customer/customer/index" addtabs="223" url="/customer/customer/index" py="khzlwh" pinyin="kehuziliaoweihu">
				<img class="menuIcon" src="__CDN__/assets/img/menuIco/customer.ico" />
				客户管理
			</a>
			<?php endif; ?>
		...
		<li>
			<?php if(($auth->check('stat/rvinforeport/index'))): ?>
			<a href="/stat/rvinforeport/index" addtabs="573" url="/stat/rvinforeport/index" py="khhfqkb" pinyin="kehuhuifangqingkuangbiao">
				<img class="menuIcon" src="__CDN__/assets/img/menuIco/rvinfo.ico" />
				回访记录
			</a>
			<?php endif; ?>
		...
		<li>
			<?php if(($auth->check('dashboard/wmindex'))): ?>
			<a  href="/dashboard/wmindex" addtabs="666" url="/dashboard/wmindex" py="ckgqyj" pinyin="cangkuguoqiyujing">
				<!-- <img class="menuIcon" src="__CDN__/assets/img/menuIco/sspb.png" /> -->
				产品过期预警
			</a>
			<?php endif; ?>
		...
		<li>
			<a href="/download/help" addtabs="560" url="/download/help" py="bzwd" pinyin="bangzhuwendang">
				<img class="menuIcon" src="__CDN__/assets/img/menuIco/doc.ico" />
				帮助文档
			</a>
		</li>
	</ul>
	<ul class="sidebar-menu menuDetail<?php if((cookie('use_simple_menu'))): ?> hidden<?php endif; ?>">
		<?php echo $menulist; ?>
	</ul>
...
<!-- /.sidebar -->
            ...
            <footer class="main-footer hide">
                <?php if((!empty($isJustLogin))): ?>
                <input type="hidden" value="1" id="i-just-login" />
                <?php endif; ?>
                <div class="pull-right hidden-xs">
                </div>
                <strong>Copyright &copy; 2017-2018 <a href="http://hfyjy.com">合肥壹加壹（国际）集团</a>.</strong> All rights
                reserved.
            </footer>
            ...
            <form method="post">
                ...
                <div class="form-group">
                    <label class="control-sidebar-subheading">
                        启用精简菜单
                        <input type="checkbox" id="switch-simple-menu" class="pull-right"<?php if((cookie('use_simple_menu'))): ?> checked<?php endif; ?>>
                    </label>
                    <!-- <p>
