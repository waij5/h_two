            ...
            <div class="tab-pane fade active in" id="one">
                <div class="widget-body no-padding">
                    ...
                    <div class="commonsearch-table hidden">
                        <form class="form-inline form-commonsearch nice-validator n-default" action="" novalidate="novalidate" id="f-commonsearch" role="form" method="post">
                            <fieldset>
                                ...
                                <div class="form-group dislocationAll">
                                    <label for="depot_id" class="control-label labelLocation"><?php echo __('Pro_status'); ?></label>
                                    <select id="depot_id" class="form-control " name="pro_status">
                                        <option data-type="" value='' >--- 请选择 ---</option>
                    ...
                    <table id="table" class="table table-striped table-bordered table-hover" 
                           data-operate-edit="<?php echo $auth->check('wm/drugs/edit'); ?>" 
                           data-operate-del="<?php echo $auth->check('wm/drugs/del'); ?>" 
                           width="100%">
                    </table>
                </div>
            </div>
