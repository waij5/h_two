...
<script type="text/javascript">
    ...
    <ul id="myTab" class="nav nav-tabs">
        <li class="active">
            <a href="#basic" data-toggle="tab">采购单明细</a>
        </li>
    </ul>
    <br>
    <div id="myTabContent" class="tab-content">
    	...
    	<?php if($row['mstatus'] ==1): ?>
	        <a href="javascript:;" class="btn btn-danger " id="verified" data-verified="<?php echo $row['man_id']; ?>"><b>核 收</b></a>
	        <a href="javascript:;" class="btn btn-primary btn-del" id="scrap" data-scrap="<?php echo $row['man_id']; ?>"><b> 作 废</b></a>
        <?php endif; if($row['mstatus'] ==2): ?>
        	<a href="javascript:;" class="btn btn-danger btn-del " ><b> 已 核 收 </b></a>
        	核收：<?php echo $row['verified_jhnum']; endif; if($row['mstatus'] ==3): ?>
        	<a href="javascript:;" class="btn btn-primary"><b> 已 作 废 </b></a>
        <?php endif; ?>
	    </div>
			   <br><br><br>     
        <div class="tab-pane fade in active" id="basic">
			...
			<div class="form-group ">
		        <label class="control-label col-xs-12 col-sm-2">产品列表:</label>
		        <div class="col-xs-12 col-sm-8">
		        ...
		        <div class="col-xs-12 col-sm-12" style="width: 100%;overflow-x: scroll;"><!--startprint-->
		            ...
		            <table id="selectedDrugs" class="table table-striped table-bordered table-hover" style="width: 1200px;text-align: center;">
		                ...
		                <tr>
		                	<?php if($row['mstatus'] ==1): ?>
				            <td class="printB" style="width: 30px;"></td>
				            <?php endif; ?>
							<td class="wpmcWidth" style="width: 80px;">产品名称</td>
		                    <td class="phWidth" style="width: 60px;">批号</td>
		                    <td class="jhslWidth" style="width: 40px;">采购数量</td>
		                    <td class="ggWidth" style="width: 60px;">规格</td>
		                    <td class="dwWidth" style="width: 20px;">单位</td>
		                    <td class="jjWidth" style="width: 40px;">成本单价</td>
		                    <td class="zjjWidth" style="width: 50px;">总成本</td>
						...
						<tr>
							<?php if($row['mstatus'] ==1): ?>
				            <td class="printB" style="width: 30px;"><a href="javascript:;" class="btn btn-xs btn-danger btn-del delPurList" data-index="<?php echo $vo['ml_id']; ?>" title="删除"><i class="fa fa-trash"></i></a></td>
				            <?php endif; ?>
		                ...
		                <tr class="printA" style="display: none;text-align: left">
		                    ...
		                    <td colspan="2">采购日期：<?php echo date("Y-m-d",$row['mcreatetime']); ?></td>
		                </tr>
		                <tr class="printA" style="display: none;text-align: left">
