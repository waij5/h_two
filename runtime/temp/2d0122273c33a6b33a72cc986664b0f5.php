                ...
                <div id="content">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <?php endif; ?>
                            <div class="content">
                                <form id="add-form" class="form-horizontal" role="form" data-toggle="validator" method="POST" action="<?php echo url('/wm/drugscf/revoke'); ?>"  autocomplete="off">
<div>
    ...
    <div class="form-group layer-footer">
        ...
        <div class="col-xs-12 col-sm-8">
            <?php if($type==1): ?><button type="submit" class="btn btn-success btn-embossed disabled" id="sure">确定撤药</button><?php else: ?><button type="button" class="btn btn-success btn-embossed disabled" id="sureCy">确定撤药</button><?php endif; ?>
