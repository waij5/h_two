            ...
            <div class="tab-pane fade active in" id="one">
                <div class="widget-body no-padding">
                    ...
                    <div class="commonsearch-table">
                        <form class="form-inline  nice-validator nice-validator n-default" action="<?php echo url('wmreport/recipe/index'); ?>" id="f-commonsearch" role="form" method="post">
...
<!--startprint-->
					...
					<div class="proreportDate" style="font-family: KaiTi;width: 100%;height: 20px;">
                        ...
                        <div style="font-weight:normal;font-size: 15px;float: left;" >
                            <b>发药总数量:</b><span style="color: #18bc9c"><?php echo !empty($totalss['fynum'])?$totalss['fynum']:'0'; ?></span>&nbsp;&nbsp;
                            <b style="color: red">发药总成本:</b><span style="color: #18bc9c"><?php echo !empty($totalss['fycost'])?$totalss['fycost']:'0'; ?></span>&nbsp;&nbsp;
                            <b>撤药总数量:</b><span style="color: #18bc9c"><?php echo !empty($totalss['cynum'])?$totalss['cynum']:'0'; ?></span>&nbsp;&nbsp;
                            <b style="color: red">撤药总成本:</b><span style="color: #18bc9c"><?php echo !empty($totalss['cycost'])?$totalss['cycost']:'0'; ?></span>&nbsp;&nbsp;
                        </div>
                        <?php endif; ?>
                           ...
                           <tr>
                            ...
                            <?php if(!empty($res)): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php if($v['sltype']=='6'): ?> 发药<?php else: ?> 撤药<?php endif; ?></td>
