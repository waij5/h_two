...
<form id="view-form" class="form-horizontal" role="form" data-toggle="validator" method="POST" action="">
    <ul id="myTab" class="nav nav-tabs">
        <li class="active">
            <a href="#basic" data-toggle="tab">物资列表</a>
        </li>
    </ul>
			            ...
			            <table id="selectedDrugs" class="table table-striped table-bordered table-hover" style="width: 950px;text-align: center;">
			                ...
			                <thead>
				                <tr>
									...
									<th style="width: 15px;">发料状态</th>
				                    <th style="width: 20px;">划扣ID</th>
				                    <th style="width: 20px;">物资单</th>
							...
							<tbody id="printTbody">
								...
								<tr>
									...
									<?php echo !empty($vo['status']) && $vo['status']==1?'<td style="color:#e73caa">待发料</td>':'<td>已发料</td>'; ?>
				                    ...
				                    <!-- <?php echo !empty($vo['status']) && $vo['status']==1?'<td><a href="javascript:;" class="btn btn-xs btn-primary btn-editone" title="发料"><i class="fa fa-mail-forward"></i></a></td>':'<td><a href="javascript:;" class="btn btn-xs btn-primary btn-editone" title="撤料"><i class="fa fa-reply"></i></a></td>'; ?> -->
								</tr>
								<?php endforeach; endif; else: echo "" ;endif; ?>
							</tbody>
							<?php endif; ?>
