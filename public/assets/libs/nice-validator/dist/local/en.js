...
(function(factory) {
    ...
    $.validator.config({
        ...
        rules: {
            ...
            ,qq: [/^[1-9]\d{4,}$/, "invalid qq"]
            ,IDcard: [/^\d{6}(19|2\d)?\d{2}(0[1-9]|1[012])(0[1-9]|[12]\d|3[01])\d{3}(\d|X)?$/, "invalid ID card no"]
            ,tel: [/^(?:(?:0\d{2,3}[\- ]?[1-9]\d{6,7})|(?:[48]00[\- ]?[1-9]\d{6}))$/, "invalid tel"]
            ,tel2: [/^[\w\s\-]{0,}$/, "invalid tel"]
            ,mobile: [/^1[3-9]\d{9}$/, "invalid mobile"]
            ,mobile2: [/^[\+]?[\d]{0,5} ?[\d]{1,11}$/, "invalid"]
            ,zipcode: [/^\d{6}$/, "invalid zipcode"]
            ,chinese: [/^[\u0391-\uFFE5]+$/, "invalid chinese characters"]
            ,username: [/^\w{3,12}$/, "请填写3-12位数字、字母、下划线"]
            ,nickname: [/^[a-zA-Z0-9_\u4e00-\u9fa5]{1,12}$/, "请填写1-12位数字、字母、下划线、中文"] 
