require.config({
    ...
    paths: {
        ...
        'qs': '../libs/qs/dist/qs',
        // 'core-js': '../../node_modules/core-js/es/index',
        'polyfill': '../../node_modules/@babel/polyfill/dist/polyfill',
        'whatwg-fetch': '../../node_modules/whatwg-fetch/dist/fetch.umd',
        'dropload': '../libs/dropload-gh-pages/dist/dropload.min',
    },
    // shim依赖配置
    shim: {
        'bootstrap': ['jquery'],
...
// coreJs, 
require(['jquery', 'bootstrap', 'polyfill', 'whatwg-fetch'], function ($, undefined, polyfill, undefined) {
    //初始配置
