define(['jquery', 'bootstrap', 'backend', 'table', 'jquery-freezeheader', 'form','bootstrap-select'], function ($, undefined, Backend, Table,undefined, Form,bootstrapSelect) {
...
//              var pro_footTop = parseInt($('#consumTable').offset().top+tableHeight)-18;
            ...
            $('#btn-export').on('click', function() {
                ...
                var url = '/wmreport/depdraw/downloadprocess?yjyWhere=' + encodeURI(yjyWhere);
        ...
        downloadprocess: function() {
            ...
            return Backend.api.commondownloadprocess('/wmreport/depdraw/downloadprocess');
        },
    };
