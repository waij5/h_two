...
//日期插件 'bootstrap-datetimepicker'     undefined
    var Controller = {
        ...
        $('#btn-export').on('click', function() {
                ...
                var url = '/wmreport/stocksurplus/downloadprocess?yjyWhere=' + encodeURI(yjyWhere);
        ...
        downloadprocess: function() {
            ...
            return Backend.api.commondownloadprocess('/wmreport/stocksurplus/downloadprocess');
        },
