...
//日期插件 'bootstrap-datetimepicker'     undefined
    var Controller = {
        ...
        $('#btn-export').on('click', function() {
                ...
                var url = '/proreport/stockbalance/downloadprocess?yjyWhere=' + encodeURI(yjyWhere);
        ...
        downloadprocess: function() {
            ...
            return Backend.api.commondownloadprocess('/proreport/stockbalance/downloadprocess');
        },
