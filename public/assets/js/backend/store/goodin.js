define(['jquery', 'bootstrap', 'backend', 'table', 'form','bootstrap-datetimepicker'], function ($, undefined, Backend, Table, Form, undefined) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'store/goodin/index',
                    add_url: 'store/goodin/add',
                    edit_url: 'store/goodin/edit',
                    // del_url: 'store/goodin/del',
                    multi_url: 'store/goodin/multi',
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'rk_type_text', title: __('Rk_type'), operate:false},
        ...
        function productSearch(keywords){
            ...
            if(keywords && depot){
                var url = '/store/goodin/proSearch';
                $.ajax({
                    type: 'POST',
                    url: url,
        ...
        function selectProduct(i){
            ...
            // var trList = parseFloat($(".clearNav").data('ps'));
                ...
                if(!ps[dataId]){
                    ...
                    $('#selectedGoods').append(appendEle);
            ...
            $('#c-depot_id').change(function(){
                ...
                /*3.24选择物品显示修改  所属仓库改变后清除记录列表所有产品的id的变量;且搜索框中内容清空*/
                ps = Array();
                $('#word').html('');
                $('.keyword').val('');
