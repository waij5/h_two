...
//日期插件 'bootstrap-datetimepicker'     undefined
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'store/drugin/index',
                    add_url: 'store/drugin/add',
                    edit_url: 'store/drugin/edit',
                    // del_url: 'store/drugin/del',
                    multi_url: 'store/drugin/multi',
        ...
        function productSearch(keywords){
            ...
            if(keywords && depot){
                var url = '/store/drugin/proSearch';
                $.ajax({
                    type: 'POST',
                    url: url,
