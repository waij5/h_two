define(['jquery', 'bootstrap', 'backend', 'table', 'form','bootstrap-datetimepicker'], function ($, undefined, Backend, Table, Form,undefined) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'store/goodstock/index',
                    add_url: 'store/goodstock/add',
                    edit_url: 'store/goodstock/edit',
                    // del_url: 'store/goodstock/del',
                    multi_url: 'store/goodstock/multi',
        ...
        add: function () {
            ...
            $('.getNum').click(function(){
                var num = 1;
                var url = '/store/goodstock/getNum';
                // alert(num);
                $.ajax({
                        type: 'POST',
                        url: url,
        ...
        function productSearch(keywords){
            ...
            if(keywords && depot){
                var url = '/store/goodstock/proSearch';
                $.ajax({
                    type: 'POST',
                    url: url,
