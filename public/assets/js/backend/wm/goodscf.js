define(['jquery', 'bootstrap', 'backend', 'table', 'form','bootstrap-datetimepicker'], function ($, undefined, Backend, Table, Form, undefined) {
    ...
    var Controller = {
        index_one: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'wm/goodscf/index_one',
                    edit_url: 'wm/goodscf/edit_one',
                ...
                [
                    ...
                    {field: 'operate', title: __('Operate'), events: {
                        'click .btn-editone': function(e, value, row, index) {
                            ...
                            Fast.api.open(options.extend.edit_url + (options.extend.edit_url.match(/(\?|&)+/) ? "&ids=" : "/ids/") + row[options.sortName], '发料'+' id '+ row[options.sortName]);
                        },
                    }, formatter: function(value, row, index, custom) {
                        return '<a href="javascript:;" class="btn btn-xs btn-success btn-editone" title="发料"><i class="fa fa-mail-forward"></i></a>';
                    }},
                ]
            ]
            });
        ...
        index_two: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'wm/goodscf/index_two',
                    edit_url: 'wm/goodscf/edit_two',
                    order_edit_url: 'cash/order/edit',
                    table: 'depot_outks',
                }
            });
                ...
                [
                    ...
                    {field: 'operate', title: __('Operate'), events: {
                        'click .btn-editone': function(e, value, row, index) {
                            e.stopPropagation();
                            var options = $(this).closest('table').bootstrapTable('getOptions');
                            Fast.api.open(options.extend.edit_url + (options.extend.edit_url.match(/(\?|&)+/) ? "&ids=" : "/ids/") + row[options.sortName], '撤料'+' id '+ row[options.sortName]);
                        },
                    }, formatter: function(value, row, index, custom) {
                        return '<a href="javascript:;" class="btn btn-xs btn-success btn-editone" title="撤料"><i class="fa fa-reply"></i></a>';
                    }},
                ]
            ]
            });
        ...
        edit_one: function () {
            ...
            $('#clear').on('click', function() {
                ...
                /*选择料品显示修改  料品列表清空时清除记录列表所有产品的id的变量*/
                ps = Array();
            ...
            $('#sureFl').click(function(){
                ...
                var baseUrl = '/wm/goodscf/dispensing';
                $.ajax({
                    type: 'POST',
                    url: baseUrl,
        ...
        edit_two: function(){
            Table.api.init({
                extend: {
                    index_url: 'wm/goodscf/edit_two',
                }
            });

            $('#sureCl').click(function(){
...
//          未发料列表
        undeliveriedlist: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'wm/goodscf/undeliveriedlist',
                ...
                columns: [
                    [
                        ...
                        {field: 'operate', title: __('Operate'), table: table, events: {
                            ...
                            formatter: function (value, row, index) {
                                return '<a href="javascript:;" class="btn btn-xs btn-success btn-delivery" title="确认发料">' + 
...
//          已发料列表
        deliveriedlist: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'wm/goodscf/deliveriedlist',
                    table: 'deduct_records',
                }
            });
                ...
                columns: [
                    [
                        ...
                        {field: 'operate', title: __('Operate'), table: table, events: {
                            ...
                            formatter: function (value, row, index) {
                                return '<a href="javascript:;" class="btn btn-xs btn-primary btn-revokey" title="撤销发料">' + 
