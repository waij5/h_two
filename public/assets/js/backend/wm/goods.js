define(['jquery', 'bootstrap', 'backend', 'table', 'form','bootstrap-datetimepicker','bootstrap-select'], function ($, undefined, Backend, Table, Form,undefined,bootstrapSelect) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'wm/goods/index',
                    add_url: 'wm/goods/add',
                    edit_url: 'wm/goods/edit',
                    multi_url: 'wm/goods/multi',
                    table: 'project',
                }
            });
                    ...
                    [
                        ...
                        events: {
                                ...
                                'click .btn-search': function (e, value, row, index) {
                                    Fast.api.open('/wm/goods/searchlot/ids/' + row['pro_id'],'物品下属批号信息  id:'+row['pro_id']);
                                },
            ...
            $('#btn-export').on('click', function() {
                var url = '/wm/goods/downloadprocess' + '?op=' + encodeURI(currentOp) + '&filter=' + encodeURI(currentFilter) ;
        ...
        downloadprocess: function() {
            return Backend.api.commondownloadprocess('/wm/goods/downloadprocess');
        },
        add: function () {
