define(['jquery', 'bootstrap', 'backend', 'table', 'form','bootstrap-datetimepicker','bootstrap-select'], function ($, undefined, Backend, Table, Form,undefined,bootstrapSelect) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'wm/drugs/index',
                    add_url: 'wm/drugs/add',
                    edit_url: 'wm/drugs/edit',
                    multi_url: 'wm/drugs/multi',
                    table: 'project',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'deduct_switch', title: '划扣设置',formatter: function(value, row) {
                        ...
                        {field: 'pro_cat', title: __('Pro_cat')},
                        ...
                        events: {
                                ...
                                'click .btn-search': function (e, value, row, index) {
                                    Fast.api.open('/wm/drugs/searchlot/ids/' + row['pro_id'],'药品下属批号信息  id:'+row['pro_id']);
                                },
            ...
            $('#btn-export').on('click', function() {
                var url = '/wm/drugs/downloadprocess' + '?op=' + encodeURI(currentOp) + '&filter=' + encodeURI(currentFilter) ;
        ...
        downloadprocess: function() {
            return Backend.api.commondownloadprocess('/wm/drugs/downloadprocess');
        },
        add: function () {
        ...
        searchlot: function () {
            ...
            $('.datetimepicker').datetimepicker(dateDrug);

            $('#table').on('click', '.sureChangeLetime', function() {
                var lot_id = $(this).data('lotss');
                // console.log(lot_id);
                var url = '/wm/drugs/changeletime';
