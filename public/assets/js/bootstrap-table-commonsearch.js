...
!function ($) {
    ...
    var createFormCommon = function (pColumns, that) {
        ...
        for (var i in pColumns) {
            ...
            if (!vObjCol.checkbox && vObjCol.field !== 'operate' && vObjCol.searchable && vObjCol.operate !== false) {
                ...
                htmlForm.push('<div class="form-group dislocationAll">');
                htmlForm.push(sprintf('<label for="%s" class="control-label searchPadding">%s</label>', vObjCol.field, vObjCol.title));
    ...
    var createFormBtn = function (that) {
        ...
        htmlBtn.push('<div class="form-group dislocationAll">');
